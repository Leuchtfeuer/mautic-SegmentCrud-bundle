#!/bin/bash
# Leuchtfeuer Definition of Done check (same script as mautic-ci-runner).
# Upstream: https://github.com/Leuchtfeuer/mautic-ci-runner/blob/main/checkDod.sh
# Run locally: make check-dod
